...
#include <QFileInfo>
//=================================
CDBHelper::CDBHelper(const QString strType /* = "sqlite"*/)
{
...
bool CDBHelper::openDB(const QString strDBname)
{
    return openDB("", 0, strDBname);
}

bool CDBHelper::openDB(const QString strSvrName,
                        const int nPort,
...
bool CDBHelper::__openMDB(const QString strMDBname, QString strUserID, const QString strPassword)
{
...
bool CDBHelper::__openMDBByUDL(const QString strUDL)
{
    QFile file(strUDL);
...
bool CDBHelper::__connectSqlServer(const QString strSvrName, const QString strDBname, const QString strUserID, const QString strUserPwd)
{
...
bool CDBHelper::__openSqlite(const QString &strDbName)
{
...
bool CDBHelper::__openMySql(QString strSvrName,
                             int nPort,
                             QString strDBname,
                             QString strUserID,
                             const QString strUserPwd)
...
/********************************************************************/
bool CDBHelper::excuteSQL(const QString strExcutePara)
{
...
bool CDBHelper::dropTable(const QString strTbl)
{
...
*                                                                       *
************************************************************************/
bool CDBHelper::isOpen() const
{
    return m_pDB->isOpen();
}

bool CDBHelper::isTableExist(const QString strTable)
{
    bool bRet = false;
    if("SQLITE" == __strDbType)
    {
...
*    Purpose:                                                       *
********************************************************************/
void *CDBHelper::openRecordsetBySql(const QString strSql)
{
    if (false == isOpen())
    {
        return nullptr;
...
void CDBHelper::closeRecordset(void *p)
{
...
bool CDBHelper::recEOF(void *p) const
{
    QSqlQuery *pQry = static_cast<QSqlQuery *>(p);
    if(nullptr == pQry)
        return true;
...
bool CDBHelper::recBOF(void *p) const
{
    QSqlQuery *pQry = static_cast<QSqlQuery *>(p);
    if(nullptr == pQry)
        return true;
...
bool CDBHelper::moveFirst(void *p) const
{
    if (false == isOpen())
    {
        return false;
...
bool CDBHelper::movePrevious(void *p) const
{
    if (false == isOpen())
    {
        return false;
...
bool CDBHelper::moveNext(void *p) const
{
    if (false == isOpen())
    {
        return false;
...
bool CDBHelper::moveLast(void *p) const
{
    if (false == isOpen())
    {
        return false;
...
bool CDBHelper::moveTo(int n, void *p) const
{
    if (false == isOpen())
    {
        return false;
...
long CDBHelper::getRecordCount(void *p) const
{
    if (false == isOpen())
    {
        return -1;
...
bool CDBHelper::exexProc(const QString strStoreProc, QString str1, QString &str2)
{
...
bool CDBHelper::execStoreProcOfArgList(int idx, const QString strStoreProc, const char *szFldsInfo, ...)
{
